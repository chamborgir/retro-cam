...
export const FILM_STOCKS = [
  {
    ...
    label: 'Kodak Gold',
    swatch: '#e8a33d',
    grade: { rMul: 1.15, rAdd: 10, gMul: 1.05, gAdd: 6, bMul: 0.85, bAdd: -8 },
    saturation: 1.05,
    grainBoost: 1,
    previewFilter: 'saturate(1.15) sepia(0.12) contrast(1.05) brightness(1.02)',
  },
  {
    id: 'superia',
    label: 'Fuji Superia',
    swatch: '#6fae8f',
    grade: { rMul: 0.97, rAdd: -2, gMul: 1.08, gAdd: 4, bMul: 1.03, bAdd: 3 },
    saturation: 0.95,
    grainBoost: 0.9,
  ...
  },
  {
    ...
    label: 'Portra Soft',
    swatch: '#e8c4b8',
    grade: { rMul: 1.06, rAdd: 12, gMul: 1.0, gAdd: 8, bMul: 0.94, bAdd: 6 },
    saturation: 0.85,
    lifted: 0.08,
    grainBoost: 0.7,
    previewFilter: 'saturate(0.85) brightness(1.06) contrast(0.92) sepia(0.08)',
  },
  {
    id: 'noir',
    label: 'Noir B&W',
  ...
  },
  {
    ...
    label: 'Vaporwave',
    swatch: '#b06bd6',
    grade: { rMul: 1.08, rAdd: 6, gMul: 0.94, gAdd: -4, bMul: 1.18, bAdd: 14 },
    saturation: 1.1,
    grainBoost: 0.8,
  ...
  },
  {
    ...
    swatch: '#d8cbb0',
    grade: { rMul: 1.0, rAdd: 18, gMul: 0.98, gAdd: 16, bMul: 0.9, bAdd: 20 },
    saturation: 0.72,
    lifted: 0.14,
    grainBoost: 0.55,
    previewFilter: 'saturate(0.65) brightness(1.1) contrast(0.85) sepia(0.18)',
  },
];

export const DEFAULT_STOCK_ID = 'gold';

export const getStock = (id) => FILM_STOCKS.find((s) => s.id === id) || FILM_STOCKS[0];
