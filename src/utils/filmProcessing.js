 ...
 *   3. Exposure     -> manual EV compensation
 *   4. White balance -> red/blue channel correction for the light source
 ...
 *   9. Prism ghost  -> dual-prism chromatic ghosting (D3D stock only)
 *   10. Date stamp  -> retro amber LCD-style timestamp, bottom right
 * --------------------------------------------------------------------- */
...
/**
 * Step 9 — D3D-style dual-prism chromatic ghost.
...
export function developPhoto(video, options) {
    ...
    applyExposure(ctx, width, height, exposureEv);
    applyWhiteBalance(ctx, width, height, whiteBalance.rMul, whiteBalance.bMul);
